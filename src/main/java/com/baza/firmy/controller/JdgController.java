...
class JdgController {
 ...
 public ResponseEntity<Page<JdgListDto>> pobierzListeJdg(
  ...
  Specification<Jdg> specification = SpecificationBuilder.specification(JdgFilterSpecification.class)
      .withParam("nazwa", nazwa)
      .withParam("pkdGlowny", pkd)
      .withParam("dataRozpoczecia", dataRozpoczecia != null ? dataRozpoczecia.format(DateTimeFormatter.ISO_DATE) : null)
