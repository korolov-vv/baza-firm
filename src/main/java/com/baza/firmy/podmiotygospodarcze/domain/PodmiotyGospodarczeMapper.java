...
interface PodmiotyGospodarczeMapper {
  ...
  @Mapping(target = "pelneInfoSpolka", ignore = true)
  @Mapping(target = "pelneInfoArchive", ignore = true)
  ...
  PodmiotGospodarczyEntity toPodmiotGospodarczyEntity(JdgSzczegolyDto dto);
  ...
  @Mapping(target = "createDate", ignore = true)
  @Mapping(target = "lastModifiedDate", ignore = true)
  @Mapping(target = "pelneInfo", ignore = true)
  @Mapping(target = "pelneInfoSpolka", source = ".")
  @Mapping(target = "pelneInfoArchive", ignore = true)
  @Mapping(target = "wlasciciel", ignore = true)
  @Mapping(target = "adresDzialalnosci", ignore = true)
  @Mapping(target = "adresKorespondencyjny", ignore = true)
