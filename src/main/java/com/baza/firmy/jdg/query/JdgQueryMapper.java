...
interface JdgQueryMapper {
  ...
  JdgListDto toJdgListDtoList(JdgViewEntity entity);

  @Named("setPkdGlownyString")
  default String setPkdGlownyString(JdgViewEntity entity) {
    return entity.getPkdGlowny().map(PkdViewEntity::getKod).orElse(Strings.EMPTY);
  }

  @Named("setPkdStringList")
  default List<String> setPkdStringList(JdgViewEntity entity) {
  ...
  default AdresDto setAdresKorespondencyjny(JdgViewEntity jdg) {
  ...
  default WlascicielDto setWlascicielDto(JdgViewEntity jdg) {
