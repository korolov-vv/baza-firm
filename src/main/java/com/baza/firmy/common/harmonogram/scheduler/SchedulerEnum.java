...
enum SchedulerEnum {
  ...
  POBIERAJ_LISTE_JDG_NOWE_SCHEDULER("POBIERAJ_LISTE_JDG_NOWE_TRIGGER", "POBIERAJ_LISTE_JDG_NOWE_JOB", "0 25 21 * * ?", PobierajListeJdgNoweJob.class),
//  EKSPORTUJ_LISTE_JDG_NOWE_SCHEDULER("EKSPORTUJ_LISTE_JDG_NOWE_TRIGGER", "EKSPORTUJ_LISTE_JDG_NOWE_JOB", "0 0 7 * * ?", EksportujListeJdgNoweJob.class),
  WYSLIJ_LISTE_JDG_NOWE_SCHEDULER("WYSLIJ_LISTE_JDG_NOWE_TRIGGER", "WYSLIJ_LISTE_JDG_NOWE_JOB", "0 25 21 * * ?", WyslijListeJdgNoweJob.class);
