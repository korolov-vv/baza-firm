...
enum SchedulerEnum {
  ...
  POBIERZ_LISTE_ZAKTUALIZOWANYCH_KRS_SCHEDULER("POBIERZ_LISTE_ZAKTUALIZOWANYCH_KRS_TRIGGER", "POBIERZ_LISTE_ZAKTUALIZOWANYCH_KRS_JOB", "0 05 1 * * ?", PobierzListeZaktualizowanychKrsJob.class),
