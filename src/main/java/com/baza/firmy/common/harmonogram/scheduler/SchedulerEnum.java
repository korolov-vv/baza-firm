...
//  POBIERAJ_LISTE_JDG_NOWE_SCHEDULER("POBIERAJ_LISTE_JDG_NOWE_TRIGGER", "POBIERAJ_LISTE_JDG_NOWE_JOB", "0 0 1 * * ?", PobierajListeJdgNoweJob.class),
  EKSPORTUJ_LISTE_JDG_NOWE_SCHEDULER("EKSPORTUJ_LISTE_JDG_NOWE_TRIGGER", "EKSPORTUJ_LISTE_JDG_NOWE_JOB", "0 25 22 * * ?", EksportujListeJdgNoweJob.class);
...
//  POBIERZ_LISTE_ZAKTUALIZOWANYCH_KRS_SCHEDULER("POBIERZ_LISTE_ZAKTUALIZOWANYCH_KRS_TRIGGER", "POBIERZ_LISTE_ZAKTUALIZOWANYCH_KRS_JOB", "0 30 0 * * ?", PobierzListeZaktualizowanychKrsJob.class),
